    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="pt-4 border-t border-gray-200">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          ...
          <button type="button" onClick={() => setEmail('finance@dealflow360.com')} className="text-xs py-1.5 border border-gray-300 rounded hover:bg-gray-50">Finance</button>
          <button type="button" onClick={() => setEmail('ops@dealflow360.com')} className="text-xs py-1.5 border border-gray-300 rounded hover:bg-gray-50">Operations</button>
